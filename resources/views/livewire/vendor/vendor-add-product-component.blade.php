                    ...
                    <div class="card-body">
                        <form enctype="multipart/form-data" wire:submit.prevent="addProduct">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="name" class="label-control">Product SubCategory</label>
                                        <select name="scategory_id" id="scategory_id" wire:model="scategory_id" class="form-control">
                                            <option value="">Select Category</option>
                                            @foreach($scategories as $cat)
                                            <option value="{{$cat->id}}">{{$cat->name}}&nbsp; Category: &nbsp;<b class="text-danger">{{$cat->category->name}}</b></option>
                                            @endforeach
                                        </select>
